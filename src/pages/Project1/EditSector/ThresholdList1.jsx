  ...
  handleSubmit = () => {
    ...
    validateFields((err, values) => {
      ...
      if(!err && newThresholdTrue === true){
        ...
        console.log('一级阈值数值:',values.threshold1);
            ...
            <Col md={12} sm={24}>
              <Form.Item label="一级阈值" {...formItemLayout}>
                {getFieldDecorator('threshold1', {
                  ...
                  <div>
                    <Input className="measuredValue" addonBefore="当前值" style={{ width: '280px',marginBottom: '10px',display:'none' }} placeholder='例如:(-,-100);(100,+)' />
                    <Input className="singleChangedValue" addonBefore="单次变化量" style={{ width: '280px',marginBottom: '10px',display:'none' }} placeholder='例如:(-,-100);(100,+)' />
                    <Input className="totalChangedValue" addonBefore="累计变化量" style={{ width: '280px',marginBottom: '10px' }} placeholder='例如:(-,-100);(100,+)' />  
                    <Input className="speedChangedValue" addonBefore="变化速率" style={{ width: '280px',marginBottom: '10px',display:'none' }} placeholder='例如:(-,-100);(100,+)' />
                  </div>                  
                )}   
              </Form.Item>
            </Col>
